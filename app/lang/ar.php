...
return [
     ...
     * Backups
     * ========================= */
    'backups.backup_management'        => 'إدارة النسخ الاحتياطية',
    'backups.create_backup'            => 'إنشاء نسخة احتياطية',
    'backups.backup_created_successfully' => 'تم إنشاء النسخة الاحتياطية بنجاح: {filename}',
    'backups.backup_creation_failed'   => 'فشل في إنشاء النسخة الاحتياطية',
    'backups.backup_error'             => 'خطأ في النسخة الاحتياطية: {error}',
    'backups.invalid_backup_file'      => 'ملف النسخة الاحتياطية غير صالح',
    'backups.backup_file_not_found'    => 'ملف النسخة الاحتياطية غير موجود',
    'backups.backup_restored_successfully' => 'تم استعادة النسخة الاحتياطية بنجاح: {filename}',
    'backups.backup_restore_failed'    => 'فشل في استعادة النسخة الاحتياطية',
    'backups.restore_error'            => 'خطأ في الاستعادة: {error}',
    'backups.backup_deleted_successfully' => 'تم حذف النسخة الاحتياطية بنجاح: {filename}',
    'backups.backup_delete_failed'     => 'فشل في حذف النسخة الاحتياطية',
    'backups.cleanup_completed'        => 'تم التنظيف: {count} نسخة احتياطية أقدم من {days} يوم تم حذفها',
    
    'backups.total_backups'            => 'إجمالي النسخ الاحتياطية',
    'backups.total_size'               => 'الحجم الإجمالي',
    'backups.latest_backup'            => 'أحدث نسخة احتياطية',
    'backups.oldest_backup'            => 'أقدم نسخة احتياطية',
    'backups.quick_actions'            => 'الإجراءات السريعة',
    'backups.cleanup_old'              => 'تنظيف النسخ القديمة',
    'backups.refresh'                  => 'تحديث',
    'backups.backup_list'              => 'قائمة النسخ الاحتياطية',
    'backups.no_backups'               => 'لا توجد نسخ احتياطية',
    'backups.no_backups_description'   => 'لم تقم بإنشاء أي نسخ احتياطية بعد. أنشئ أول نسخة احتياطية لحماية بياناتك.',
    'backups.create_first_backup'      => 'إنشاء أول نسخة احتياطية',
    
    'backups.filename'                 => 'اسم الملف',
    'backups.type'                     => 'النوع',
    'backups.size'                     => 'الحجم',
    'backups.created_at'               => 'تاريخ الإنشاء',
    'backups.actions'                  => 'الإجراءات',
    'backups.download'                 => 'تحميل',
    'backups.restore'                  => 'استعادة',
    'backups.delete'                   => 'حذف',
    
    'backups.backup_type'              => 'نوع النسخة الاحتياطية',
    'backups.type_full'                => 'نسخة احتياطية كاملة',
    'backups.type_structure'           => 'الهيكل فقط',
    'backups.type_data'                => 'البيانات فقط',
    'backups.backup_type_help'         => 'النسخة الاحتياطية الكاملة تشمل الهيكل والبيانات. الهيكل فقط يشمل تعريفات الجداول. البيانات فقط تشمل بيانات الجداول.',
    'backups.include_data'             => 'تضمين البيانات',
    'backups.compress_backup'          => 'ضغط النسخة الاحتياطية',
    'backups.compress_help'            => 'النسخ المضغوطة أصغر حجماً ولكنها تستغرق وقتاً أطول في الإنشاء والاستعادة.',
    
    'backups.cleanup_warning'          => 'سيؤدي هذا إلى حذف ملفات النسخ الاحتياطية القديمة نهائياً. لا يمكن التراجع عن هذا الإجراء.',
    'backups.delete_older_than'        => 'حذف النسخ الأقدم من',
    'backups.days'                     => 'أيام',
    
    'backups.restore_backup'           => 'استعادة النسخة الاحتياطية',
    'backups.restore_warning'          => 'سيؤدي هذا إلى استبدال قاعدة البيانات الحالية ببيانات النسخة الاحتياطية. ستفقد جميع البيانات الحالية!',
    'backups.restore_confirm'          => 'هل أنت متأكد من أنك تريد استعادة هذه النسخة الاحتياطية؟',
    'backups.backup_file'              => 'ملف النسخة الاحتياطية',
    
    'backups.delete_backup'            => 'حذف النسخة الاحتياطية',
    'backups.delete_warning'           => 'سيؤدي هذا إلى حذف ملف النسخة الاحتياطية نهائياً. لا يمكن التراجع عن هذا الإجراء.',
    'backups.delete_confirm'           => 'هل أنت متأكد من أنك تريد حذف هذه النسخة الاحتياطية؟',
];
