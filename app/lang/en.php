...
return [
    ...
    'users.showing_users' => 'Showing {count} of {total} users',
    'users.page_info' => 'Page {current} of {pages}',
    'users.rbac_roles' => 'RBAC Roles',
    'users.created' => 'Created',
    'users.no_users_found_criteria' => 'No users found matching your criteria.',
    'users.no_rbac_roles' => 'No RBAC roles',
    'users.never' => 'Never',
    ...
    'dashboard.sales_vs_purchases' => 'Sales vs Purchases',
    'dashboard.top_products' => 'Top Products (Last 30 Days)',
    'dashboard.sales' => 'Sales',
    'dashboard.purchases' => 'Purchases',
    'dashboard.date' => 'Date',
    'dashboard.amount' => 'Amount',
    'dashboard.value' => 'Value',
    'dashboard.quotes_today' => 'Quotes Today',
    'dashboard.orders_today' => 'Orders Today',
    'dashboard.invoices_today' => 'Invoices Today',
    'dashboard.purchases_today' => 'Purchases Today',
    'dashboard.alerts'          => 'Alerts',

    // Import/Export
    'importexport.import_export' => 'Import/Export',
    'importexport.export_data' => 'Export Data',
    'importexport.export_type' => 'Export Type',
    'importexport.bulk_export' => 'Bulk Export',
    'importexport.module_export' => 'Module Export',
    'importexport.custom_export' => 'Custom Export',
    'importexport.export_type_help' => 'Choose the type of export you want to perform',
    'importexport.select_module' => 'Select Module',
    'importexport.choose_module' => 'Choose a module...',
    'importexport.all_modules' => 'All Modules',
    'importexport.inventory' => 'Inventory',
    'importexport.products' => 'Products',
    'importexport.categories' => 'Categories',
    'importexport.makes' => 'Makes',
    'importexport.models' => 'Models',
    'importexport.warehouses' => 'Warehouses',
    'importexport.sales' => 'Sales',
    'importexport.customers' => 'Customers',
    'importexport.quotes' => 'Quotes',
    'importexport.orders' => 'Orders',
    'importexport.invoices' => 'Invoices',
    'importexport.purchasing' => 'Purchasing',
    'importexport.suppliers' => 'Suppliers',
    'importexport.purchase_orders' => 'Purchase Orders',
    'importexport.purchase_invoices' => 'Purchase Invoices',
    'importexport.system' => 'System',
    'importexport.users' => 'Users',
    'importexport.export_format' => 'Export Format',
    'importexport.export_info' => 'Export Information',
    'importexport.supported_formats' => 'Supported Formats',
    'importexport.csv_description' => 'Comma-separated values, compatible with Excel',
    'importexport.excel_description' => 'Microsoft Excel format',
    'importexport.pdf_description' => 'Portable Document Format for printing',
    'importexport.export_types' => 'Export Types',
    'importexport.bulk_description' => 'Export all data from selected module',
    'importexport.module_description' => 'Export specific module data with relationships',
    'importexport.custom_description' => 'Export with custom filters and selections',
    'importexport.note' => 'Note',
    'importexport.export_note' => 'Large exports may take time to process. Please be patient.',
    'importexport.quick_export' => 'Quick Export',
    'importexport.export_products' => 'Export Products',
    'importexport.export_customers' => 'Export Customers',
    'importexport.export_invoices' => 'Export Invoices',
    'importexport.export_all' => 'Export All Data',
    'importexport.please_select_module' => 'Please select a module to export',
    'importexport.please_select_format' => 'Please select an export format',
    ...
    'settings.company_name_placeholder' => 'Your Company Name',
    'settings.address' => 'Address',
    'settings.company_address_placeholder' => 'Company address for invoices',
    'settings.phone_placeholder' => '+20 xxx xxx xxxx',
    'settings.email_placeholder' => 'info@company.com',
    'settings.currency_settings' => 'Currency Settings',
    'settings.base_currency' => 'Base Currency',
    'settings.currency_symbol' => 'Currency Symbol',
    'settings.symbol_position' => 'Symbol Position',
    'settings.before_symbol' => 'Before ($ 100.00)',
    'settings.after_symbol' => 'After (100.00 EGP)',
    'settings.decimal_places' => 'Decimal Places',
    'settings.tax_settings' => 'Tax Settings',
    'settings.default_tax_rate' => 'Default Tax Rate (%)',
    'settings.tax_calculation_method' => 'Tax Calculation Method',
    'settings.tax_exclusive' => 'Tax Exclusive (Tax added to amount)',
    'settings.tax_inclusive' => 'Tax Inclusive (Tax included in amount)',
    'settings.current_tax_rates' => 'Current Tax Rates',
    'settings.no_tax_rates_configured' => 'No tax rates configured',
    'settings.default' => 'Default',
    'settings.active_currencies' => 'Active Currencies',
    'settings.no_currencies_configured' => 'No currencies configured',
    'settings.code' => 'Code',
     ...
     * Backups
     * ========================= */
    'backups.backup_management'        => 'Backup Management',
    'backups.create_backup'            => 'Create Backup',
    'backups.backup_created_successfully' => 'Backup created successfully: {filename}',
    'backups.backup_creation_failed'   => 'Backup creation failed',
    'backups.backup_error'             => 'Backup error: {error}',
    'backups.invalid_backup_file'      => 'Invalid backup file',
    'backups.backup_file_not_found'    => 'Backup file not found',
    'backups.backup_restored_successfully' => 'Backup restored successfully: {filename}',
    'backups.backup_restore_failed'    => 'Backup restore failed',
    'backups.restore_error'            => 'Restore error: {error}',
    'backups.backup_deleted_successfully' => 'Backup deleted successfully: {filename}',
    'backups.backup_delete_failed'     => 'Backup delete failed',
    'backups.cleanup_completed'        => 'Cleanup completed: {count} backups older than {days} days deleted',
    
    'backups.total_backups'            => 'Total Backups',
    'backups.total_size'               => 'Total Size',
    'backups.latest_backup'            => 'Latest Backup',
    'backups.oldest_backup'            => 'Oldest Backup',
    'backups.quick_actions'            => 'Quick Actions',
    'backups.cleanup_old'              => 'Cleanup Old Backups',
    'backups.refresh'                  => 'Refresh',
    'backups.backup_list'              => 'Backup List',
    'backups.no_backups'               => 'No Backups Found',
    'backups.no_backups_description'   => 'You haven\'t created any backups yet. Create your first backup to protect your data.',
    'backups.create_first_backup'      => 'Create First Backup',
    
    'backups.filename'                 => 'Filename',
    'backups.type'                     => 'Type',
    'backups.size'                     => 'Size',
    'backups.created_at'               => 'Created At',
    'backups.actions'                  => 'Actions',
    'backups.download'                 => 'Download',
    'backups.restore'                  => 'Restore',
    'backups.delete'                   => 'Delete',
    
    'backups.backup_type'              => 'Backup Type',
    'backups.type_full'                => 'Full Backup',
    'backups.type_structure'           => 'Structure Only',
    'backups.type_data'                => 'Data Only',
    'backups.backup_type_help'         => 'Full backup includes both structure and data. Structure only includes table definitions. Data only includes table data.',
    'backups.include_data'             => 'Include Data',
    'backups.compress_backup'          => 'Compress Backup',
    'backups.compress_help'            => 'Compressed backups are smaller but take longer to create and restore.',
    
    'backups.cleanup_warning'          => 'This will permanently delete old backup files. This action cannot be undone.',
    'backups.delete_older_than'        => 'Delete Backups Older Than',
    'backups.days'                     => 'Days',
    
    'backups.restore_backup'           => 'Restore Backup',
    'backups.restore_warning'          => 'This will completely replace the current database with the backup data. All current data will be lost!',
    'backups.restore_confirm'          => 'Are you sure you want to restore this backup?',
    'backups.backup_file'              => 'Backup File',
    
    'backups.delete_backup'            => 'Delete Backup',
    'backups.delete_warning'           => 'This will permanently delete the backup file. This action cannot be undone.',
    'backups.delete_confirm'           => 'Are you sure you want to delete this backup?',
];
