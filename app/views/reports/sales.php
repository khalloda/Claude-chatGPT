...
<section>
  ...
  <div style="display:flex;gap:24px;margin:8px 0;">
    <div>Total Invoices: <strong><?= number_format((float)$totals['invoices'],2) ?></strong></div>
    <div>Total Returns: <strong><?= number_format((float)$totals['returns'],2) ?></strong></div>
    <div>Net Sales: <strong><?= number_format((float)$totals['net_sales'],2) ?></strong></div>
    <div>Payments Received: <strong><?= number_format((float)$totals['payments'],2) ?></strong></div>
  </div>
